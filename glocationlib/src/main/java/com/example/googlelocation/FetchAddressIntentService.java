...
public class FetchAddressIntentService extends IntentService {
    ...
    private String TAG = FetchAddressIntentService.class.getSimpleName();
    ...
    protected void onHandleIntent(@Nullable Intent intent) {
        ...
        if (addresses == null || addresses.size()  == 0) {
            ...
            for(int i = 0; i <= address.getMaxAddressLineIndex(); i++) {
                ...
                Log.e(TAG, "unknown: "+address.getSubAdminArea());
                Log.e(TAG, "city: "+address.getAdminArea());
                Log.e(TAG, "country: "+address.getCountryName());
                Log.e(TAG, "unknown: "+address.getPremises());
                Log.e(TAG, "unknown: "+address.getSubLocality());
